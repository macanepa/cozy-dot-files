...
keys = [
    ...
    Key([], "XF86AudioMute", lazy.spawn(mute_path)),
    Key([], "XF86AudioMicMute", lazy.spawn(mic_path)),
    # Music
    ...
    # Brightness
    Key([], "XF86MonBrightnessUp", lazy.spawn(f"{bright_path} +10%")),
    Key([], "XF86MonBrightnessDown", lazy.spawn(f"{bright_path} 10%-")),
